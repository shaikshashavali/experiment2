...
temp = "B.TECH IT";
// Toast.makeText(MainActivity.this, "Selected: " + temp,
// Toast.LENGTH_SHORT).show();
}
});
// ListView Item
...
// Toast.makeText(MainActivity.this, "Selected: " + area,
// Toast.LENGTH_SHORT).show();
}
});
...
Toast.makeText(MainActivity.this, "Your Data Saved!!!", 4000).show();
}
});
}
